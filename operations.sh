...
h_function() {
    printf "Help Information:\n%s\n%s\n%s\n%s\n%s\n%s\n%s" "-s: Set a variable" "-d: Run 'terraform destroy'" "-D: Run 'terraform destroy -auto-approve'" "-a: Run 'terraform apply'" "-A: Run 'terraform apply -auto-approve'" "-p: Run 'terraform plan'" "-h: Display this help information"
}
